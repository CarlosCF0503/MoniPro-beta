...
// ========================================================================= //
// CORREÇÃO: Configuração de CORS para desenvolvimento local
// O '*' permite que requisições de qualquer origem sejam aceitas.
app.use(cors());
// ========================================================================= //
...
app.post('/login', async (req, res) => {
    ...
    // ========================================================================= //
    // CORREÇÃO: Removido o typo 'inaction' do catch
    } catch (error) {
